...
class GlowFlow(tfp.bijectors.Bijector):
    def __init__(self, num_layers=1, depth=1, coupling_nn_ctor=resnet_glow(),
        ...
        # So we inver the directions here to allow Glow to be used as a standard TFP bijector
        self.flow = tfp.bijectors.Invert(tfp.bijectors.Chain(list(reversed(flow_steps))))
